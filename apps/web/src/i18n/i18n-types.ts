...
type RootTranslation = {
	 ...
	 * @param {unknown} provider
	 */
	accountUnlinkedSuccessfully: RequiredParams<'provider'>
	/**
	 * Д​е​й​с​т​в​и​я
	 */
	actions: string
	 ...
	 * @param {unknown} role
	 */
	roleRemovingQuestion: RequiredParams<'role'>
	/**
	 * Р​о​л​и
	 */
	roles: string
...
export type TranslationFunctions = {
	 ...
	 */
	accountUnlinkedSuccessfully: (arg: { provider: unknown }) => LocalizedString
	/**
	 * Действия
	 */
	 ...
	 */
	roleRemovingQuestion: (arg: { role: unknown }) => LocalizedString
	/**
	 * Роли
	 */
